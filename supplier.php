    ...
    <div class="card">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h2>جديد</h2>
                                <form class="form-horizontal" action="controller/supplier.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="phone" placeholder="الحساب">
                                        </div>
                                    </div>
        ...
        <div class="card-body">
            <table class="table">
                ...
                $cat = new supplier();
                $result=$cat->Getsupplier();
                while ($row = $result->fetch()){
                    ?>
                    <form action="controller/supplier.php" method="post" class="form">
                        <td>  <input name="name" class="form-control" value="<?php echo $row['name'];?>"</td>
                        <td>  <input name="phone" class="form-control" value="<?php echo $row['phone'];?>"</td>
                        <td>
