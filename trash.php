    ...
    <div class="card">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="form-horizontal" action="controller/trash.php" method="post">
                                        ...
                                        <button class="form-control btn btn-success" type="submit" name="totrash" >أصافة</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                <?php require_once('./controller/trash.php');
                $cat = new trash();
                $result=$cat->Gettrash();
